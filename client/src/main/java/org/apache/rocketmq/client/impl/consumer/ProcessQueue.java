 ...
 *
 * PullMessageService从消息服务器默认每次拉取32条消息，按消息队列偏移量顺序放在ProcessQueue中
 * PullMessageService然后将消息提交到消费者线程池，消息成功消费后从ProcessQueue中移除
 */
public class ProcessQueue {
    ...
    /**
     * 消息存储容器
     * 键为消息在ConsumerQueue中的偏移量，MessageExt为消息实体
     */
